...
public class Refund extends PersistedObject {
    ...
    private Integer refundType; // 1 - Full Refund, 2 - Partial Refund, 3 - Refund Only (No Return)

    @Column(name = "refund_reason", length = 256)
    private String refundReason;

    // 0 - Applied, 1 - Under Review, 2 - Approved, 3 - Rejected, 4 - Refunding, 5 - Refund Successful, 6 - Refund Failed
    ...
    // 1 - Original Payment Method, 2 - Refund to Balance, 3 - Refund to Bank Card
